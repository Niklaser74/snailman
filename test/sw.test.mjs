...
assert.match(version, /^snailman-v\d+$/, 'cache name must be prefixed snailman-');
assert.ok(sw.includes("k.startsWith('snailman-')"), 'activate must only delete own caches');
