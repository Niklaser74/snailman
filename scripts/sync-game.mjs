...
//
// Only what Snailman actually uses is vendored. game.js (the duel simulation),
// terrain.js (a side-view collision mask with destructible ground) and dmath.js
// belong to Snäckmageddon's world, not to a hedge maze — leaving them out keeps
// sw.js and the offline cache honest about what ships.
